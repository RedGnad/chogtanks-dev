...
public class SimpleTankRespawn : NetworkBehaviour
{
    [Header("Respawn")]
    ...
    private void InitializeComponents()
    {
        ...
        {
            Debug.LogWarning($"[TANK] Aucun renderer trouvé pour {(Object.InputAuthority != null ? Object.InputAuthority.ToString() : "Unknown")}");
        }
        
        if (colliders.Count == 0)
        {
            Debug.LogWarning($"[TANK] Aucun collider trouvé pour {(Object.InputAuthority != null ? Object.InputAuthority.ToString() : "Unknown")}");
        }
    }
    ...
    public void ResetTankState()
    {
        ...
        else
        {
            ...
            {
                Debug.LogWarning($"[TANK] Impossible de trouver TankHealth2D pour {(Object.InputAuthority != null ? Object.InputAuthority.ToString() : "Unknown")}");
            }
        }
        
        
        if (TankComponentAdder.Instance != null && Runner != null && Runner.IsConnectedToServer)
        {
            Debug.Log($"[TANK] Vérification des composants via TankComponentAdder pour {(Object.InputAuthority != null ? Object.InputAuthority.ToString() : "Unknown")}");
        }
    }
    ...
    public void DieRpc(int killerActorNumber)
    {
        if (isDead)
        {
            return;
        ...
        if (Runner != null && Runner.IsConnectedToServer && killerActorNumber > 0 && killerActorNumber != Object.InputAuthority.PlayerId)
        {
            ...
            if (killManager != null)
            {
                killManager.ShowKillNotification(killerActorNumber, Object.InputAuthority.PlayerId);
            }
            else
            {
    ...
    private IEnumerator RespawnCoroutine()
    {
        ...
        if (spawner != null && spawner.spawnPoints != null && spawner.spawnPoints.Length > 0)
        {
            ...
            int actorNumber = Object.InputAuthority.PlayerId;
            int spawnIdx = 0;
        ...
        RespawnTankRpc(respawnPosition.x, respawnPosition.y, respawnPosition.z);
    ...
    [Rpc(RpcSources.All, RpcTargets.All)]
    public void RespawnTankRpc(float x, float y, float z)
    {
        if (GameManager.Instance != null && GameManager.Instance.isGameOver)
        {
            return;
    ...
    [Rpc(RpcSources.All, RpcTargets.All)]
    public void ShowWinnerUIRpc(string winnerName)
    {
